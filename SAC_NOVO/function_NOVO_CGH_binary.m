function [ NOVOCGH ] = function_NOVO_CGH_binary( System, HStacks, Masks,D_Masks,Depths,NormOptions)
...
thresholdl = NormOptions.LowThreshold * (pct9999 + pct100)/2;
...
dmaskfun = @(i1, i2) D_Masks(:,:,i1:i2);
f = @(x)function_FunObj_binary( x, System.source, Depths, System.Nx, System.Ny, thresholdh, thresholdl, maskfun,dmaskfun, kernelfun, System.useGPU);
% f = @(x)function_FunObj_log(x, System.source, Depths, System.Nx, System.Ny, thresholdh, thresholdl, maskfun, kernelfun, System.useGPU);
...
matlab_options = optimoptions('fmincon','GradObj','on', 'display', displayoption, ...
    ...
    'TolX', 1e-20, 'TolFun', 1e-12 , 'OutputFcn', @myoutput);
